...
Everything here is shared for **non-commercial use only** — feel free to explore, play around with it, learn from it, or build your own fan projects. Just **don’t sell it or use it to make money**.
...
2) any loop de loop that has some cinematic camera movement works only from one direction
